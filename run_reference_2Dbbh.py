...
OUTPUT_DIRECTORY = '/n/home00/ggrosso/NPLM-GWAK/dictionary-learning/new-tf/out/'
...
config_json = {
    ...
    "patience": 100,
    "plt_patience": 1000,
    "width_init": 0.5, #[0.3 0.8 1.4 2.2 3.7]
    "number_centroids": 5,#1000,
    "coeffs_reg_lambda":  1e-5,
    "widths_reg_lambda":  0,
...
if __name__ == '__main__':
    ...
    if args.local:
        ...
        for i in range(ntoys):
            ...
            script_sbatch.write("#SBATCH -t 0-02:00\n")
